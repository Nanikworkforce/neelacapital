          ...
          <form onSubmit={handleSubmit} className="p-5 sm:p-6 lg:p-8 space-y-5 sm:space-y-6">
            ...
            <div className="space-y-3">
              ...
              <div className="relative">
                ...
                <input
                  id="admin-email"
                  type="email"
                  className="w-full pl-12 pr-4 py-3 border-2 border-slate-200 rounded-xl focus:ring-4 focus:ring-red-500/20 focus:border-red-500 outline-none transition-all bg-white text-slate-900 placeholder-slate-400"
                  placeholder="admin@neelacapital.com"
                  value={email}
            ...
            <div className="space-y-3">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-12 pr-12 py-3 border-2 border-slate-200 rounded-xl focus:ring-4 focus:ring-red-500/20 focus:border-red-500 outline-none transition-all bg-white text-slate-900 placeholder-slate-400"
            ...
            <div className="pt-2">
              <button
                type="submit"
                disabled={isLoading}
                className="w-full py-3.5 sm:py-4 bg-gradient-to-r from-gray-900 to-gray-800 text-white font-bold rounded-xl hover:shadow-xl hover:shadow-slate-500/30 disabled:opacity-50 disabled:cursor-not-allowed transition-all duration-300 flex justify-center items-center gap-2 focus:outline-none focus:ring-4 focus:ring-red-500/30"
              >
                {isLoading ? (
                  <>
