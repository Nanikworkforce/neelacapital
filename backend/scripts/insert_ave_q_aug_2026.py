"""Insert Avenue Q Aug 2026 P&L with per-door income and unit-level expenses."""
import os
import sys
...
EFFECTIVE_INCOME = Decimal('4511.80')
...
def main():
    ...
    print('Avenue Q Aug 2026 inserted')
    print(f"  Aug cash flow:  income=${aug['income']:,.2f} expenses=${aug['expenses']:,.2f} net=${aug['net']:,.2f}")
    print(f"  NOI (Aug):      ${aug['net']:,.2f}")
