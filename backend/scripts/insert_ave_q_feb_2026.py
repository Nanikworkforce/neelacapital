"""Insert Avenue Q Feb 2026 P&L with per-door income and unit-level expenses."""
import os
import sys
...
# Door 1 = Unit A = Unit 1; Door 3 = Unit C = Unit 3; Door 4 = Unit D = Unit 4
DOORS = [
    (1, Decimal('1750.00'), 'occupied'),
    (2, Decimal('700.03'), 'occupied'),
    (3, Decimal('1200.00'), 'vacant'),
...
UNIT_EXPENSES = [
    (1, 'Property Management Fees', Decimal('40.00')),
    (2, 'Cleaning Fees', Decimal('120.00')),
    (2, 'Supplies & Materials', Decimal('50.00')),
    (2, 'Electricity - Unit', Decimal('250.20')),
    (2, 'Water - Unit', Decimal('739.43')),
    (2, 'Internet - Unit', Decimal('31.73')),
...
EFFECTIVE_INCOME = Decimal('3550.03')
OPERATING_SUMMARY = Decimal('1221.36')
...
def main():
    ...
    print('Avenue Q Feb 2026 inserted')
    print(f"  Feb cash flow:  income=${feb['income']:,.2f} expenses=${feb['expenses']:,.2f} net=${feb['net']:,.2f}")
    print('  Units:')
