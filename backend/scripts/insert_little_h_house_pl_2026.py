"""Little H House — Jan–Apr 2026 property P&L (master line-item format)."""
import os
import sys
...
MONTHS = [
    (
        ...
        [
            ...
            ('Electricity', Decimal('135.81')),
            ('Internet', Decimal('23.55')),
            ('Water Bill', Decimal('43.05')),
            ('Kitchen & Bathroom supplies', Decimal('50.00')),
            ('Cleaning Fees', Decimal('60.00')),
        ],
    ),
    (
        2,
        ...
        [
            ('Rent', Decimal('1200.00')),
            ('Electricity', Decimal('144.86')),
            ('Internet', Decimal('23.55')),
            ('Water Bill', Decimal('35.18')),
            ('Kitchen & Bathroom supplies', Decimal('50.00')),
            ('Cleaning Fees', Decimal('240.00')),
        ],
    ),
    (
        3,
        ...
        [
            ('Rent', Decimal('1200.00')),
            ('Electricity', Decimal('158.91')),
            ('Internet', Decimal('23.55')),
            ('Water Bill', Decimal('70.36')),
            ('Kitchen & Bathroom supplies', Decimal('50.00')),
            ('Cleaning Fees', Decimal('240.00')),
        ],
    ),
    (
        ...
        [
            ('Rent', Decimal('1200.00')),
            ('Electricity', Decimal('124.20')),
            ('Internet', Decimal('23.55')),
            ('Water Bill', Decimal('105.54')),
            ('Kitchen & Bathroom supplies', Decimal('50.00')),
            ('Cleaning Fees', Decimal('240.00')),
        ],
    ),
...
def main():
    ...
    print(f'{LISTING} Jan–Apr 2026 P&L inserted')
    for m in result['monthly']:
        if m['month'] in (1, 2, 3, 4):
            print(
