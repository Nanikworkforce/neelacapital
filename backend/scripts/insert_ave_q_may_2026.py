"""Insert Avenue Q May 2026 P&L with per-door income and unit-level expenses."""
import os
import sys
...
DOORS = [
    ...
    (2, Decimal('1627.20'), 'occupied'),
    (3, Decimal('606.25'), 'vacant'),
    (4, Decimal('1050.00'), 'occupied'),
]
...
FINANCIALS = {
    ...
    'loan_term_years': 30,
    'monthly_mortgage_payment': Decimal('4205.88'),
    'land_value': Decimal('85000.00'),
    'annual_depreciation_years': Decimal('27.5'),
}

EFFECTIVE_INCOME = Decimal('5083.45')
...
def main():
    ...
    print('Avenue Q May 2026 inserted')
    print(f"  May cash flow:  income=${may['income']:,.2f} expenses=${may['expenses']:,.2f} net=${may['net']:,.2f}")
    print(f"  NOI (May):      ${may['net']:,.2f}")
