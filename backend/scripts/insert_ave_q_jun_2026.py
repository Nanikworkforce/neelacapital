"""Insert Avenue Q Jun 2026 P&L with per-door income and unit-level expenses."""
import os
import sys
...
DOORS = [
    (1, Decimal('1760.00'), 'occupied'),
    (2, Decimal('1707.00'), 'occupied'),
    (3, Decimal('680.94'), 'vacant'),
...
EFFECTIVE_INCOME = Decimal('5197.94')
...
def main():
    ...
    print('Avenue Q Jun 2026 inserted')
    print(f"  Jun cash flow:  income=${jun['income']:,.2f} expenses=${jun['expenses']:,.2f} net=${jun['net']:,.2f}")
    print(f"  NOI (Jun):      ${jun['net']:,.2f}")
