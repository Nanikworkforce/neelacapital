"""Insert Avenue Q Jul 2026 P&L with per-door income and unit-level expenses."""
import os
import sys
...
EFFECTIVE_INCOME = Decimal('4870.51')
...
def main():
    ...
    jul = result['monthly'][6]

    print('Avenue Q Jul 2026 inserted')
    print(f"  Jul cash flow:  income=${jul['income']:,.2f} expenses=${jul['expenses']:,.2f} net=${jul['net']:,.2f}")
    print(f"  NOI (Jul):      ${jul['net']:,.2f}")
