"""The Hideaway — Jan–Apr 2026 property P&L (master line-item format)."""
import os
import sys
...
MONTHS = [
    (
        ...
        [
            ...
            ('Electricity', Decimal('148.69')),
            ('Internet', Decimal('23.55')),
            ('Water Bill', Decimal('78.39')),
    ...
    (
        ...
        [
            ('Rent', Decimal('1300.00')),
            ('Electricity', Decimal('108.36')),
            ('Internet', Decimal('23.55')),
            ('Water Bill', Decimal('34.65')),
            ('Kitchen & Bathroom supplies', Decimal('50.00')),
    ...
    (
        ...
        [
            ('Rent', Decimal('1300.00')),
            ('Electricity', Decimal('134.42')),
            ('Internet', Decimal('23.55')),
            ('Water Bill', Decimal('87.52')),
            ('Kitchen & Bathroom supplies', Decimal('50.00')),
    ...
    (
        ...
        [
            ('Rent', Decimal('1300.00')),
            ('Electricity', Decimal('129.42')),
            ('Internet', Decimal('23.55')),
            ('Water Bill', Decimal('123.44')),
            ('Kitchen & Bathroom supplies', Decimal('50.00')),
            ('Cleaning Fees', Decimal('300.00')),
        ],
    ),
