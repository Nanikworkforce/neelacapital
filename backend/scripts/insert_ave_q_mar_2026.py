"""Insert Avenue Q Mar 2026 P&L with per-door income and unit-level expenses."""
import os
import sys
...
DOORS = [
    ...
    (2, Decimal('1500.00'), 'vacant'),
    (3, Decimal('293.33'), 'vacant'),
...
EFFECTIVE_INCOME = Decimal('3143.33')
...
def main():
    ...
    print('Avenue Q Mar 2026 inserted')
    print(f"  Mar cash flow:  income=${mar['income']:,.2f} expenses=${mar['expenses']:,.2f} net=${mar['net']:,.2f}")
    print(f"  NOI (Mar):      ${mar['net']:,.2f}")
